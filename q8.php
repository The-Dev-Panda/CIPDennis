            ...
            <div class="col-sm-8 col-md-6 col-lg-4">
                <div class="card p-4 shadow rounded">
                    ...
                    <form action="q8.php" method="post">
                        <p class="mb-3 fw-bold">Goldfish have a three-second memory.</p>

                        <div class="form-check mb-2">
                            <input class="form-check-input" type="radio" id="true" name="q8" value="a" required>
                            <label class="form-check-label" for="true">True</label>
                        </div>
                        <div class="form-check mb-4">
                            <input class="form-check-input" type="radio" id="false" name="q8" value="b" required>
